...
from ml4co_kit import atsp_greedy_decoder, atsp_2opt_local_search
...
class MatDIFFNetDecoder(object):
    ...
    def decode(
        self,
        heatmap: Union[np.ndarray, jittor.Var],
        dists: Union[np.ndarray, jittor.Var] = None,
        edge_index: Union[np.ndarray, jittor.Var] = None,
        sparse: bool = False,
